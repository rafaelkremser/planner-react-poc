          ...
          <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              <div className="py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2">
                <span className="text-zinc-300">rafael@email.com</span>
                <button type="button">
            ...
            <form className="p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2">
              <div className="p-2 flex items-center flex-1 gap-2">
                ...
                <input type="text" placeholder="Digite o e-mail do convidado" className="bg-transparent text-base placeholder-zinc-400 outline-none flex-1"/>
              </div>
